...
public class SupplyRequest {
    ...
    public static SupplyRequest of(RequestDTO requestDTO) {
        return new SupplyRequest
                (requestDTO.getDepartmentName(), requestDTO.getItem(), requestDTO.getQuantity(), requestDTO.getMeasureUnit(), requestDTO.getComments());
    }
